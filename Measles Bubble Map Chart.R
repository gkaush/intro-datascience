...
ggplot() +
  ...
  scale_fill_manual(values = c("hotpink", "aquamarine")) +
  ...
  labs(
    title = "Global Measles Caseloads",
    caption = "This map visualizes measles caseloads per country and\nwhether or not they have policies that require measles vaccinations.",
    size = "Measles Caseload",
